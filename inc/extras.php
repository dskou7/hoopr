...
function videostories_theme_admin_notice() {
    ...
    if ( ! get_user_meta($user_id, 'videostories_ignore_notice') ) {
        ...
        printf(__('<h4 style="font-size: 20px; color: #5FA52A; font-weight: normal; margin-bottom: 10px; margin-top: 5px;"><a href="https://themeforest.net/item/videostories-responsive-video-wordpress-theme-for-marketers/20828897?ref=jewel_theme" target="_blank">' . __('Get VideoStories PRO $29 Today! ', 'videostories') . '</a></h4>Check out Premium Features of <a href="https://themeforest.net/item/videostories-responsive-video-wordpress-theme-for-marketers/20828897?ref=jewel_theme" target="_blank">' . __('VideoStories PRO', 'videostories') . '</a> Theme. Compare Why this Theme is really Awesome !!! <br>

            <strong>
            Download
            <a href="https://themeforest.net/item/elevation-charitynonprofitfundraising-wp-theme/16027141" target="_blank">' . __('$49 worth Elevation', 'videostories') . '</a> Completely Free !!! ( December Free Item of the Month)
            </strong>
